...
load_subject_performance_data <- function () {
  ...
  all_gait_data <- all_gait_data %>%
    mutate(diff_walk_speed_protocol1 = mean_walking_speed_protocol1_DT_walk - mean_walking_speed_protocol1_ST_walk,
           ...
           dt_cost_stance_time_protocol1 = -calculate_dt_cost(mean_stance_time_protocol1_DT_walk, mean_stance_time_protocol1_ST_walk),
           dt_cost_stance_time_protocol3 = -calculate_dt_cost(mean_stance_time_protocol3_DT_navigation, mean_stance_time_protocol3_ST_navigation),
  ...
  labels(performance_data)  <- c(
    ...
    dt_cost_cadence_protocol3 = "DT cost cadence, %",
    dt_cost_single_support_protocol3 = "DT cost single support, %",
    dt_cost_stance_time_protocol3 = "DT cost stance time, %",
    ...
    mean_single_support_protocol2_ST_walk = "Single support (straight), s",
    mean_single_support_protocol2_ST_navigation = "Single support (navigation), s",
    mean_single_support_protocol3_ST_navigation = "Single support (ST), s",
    mean_single_support_protocol3_DT_navigation = "Single support (DT), s",
    mean_stance_time_protocol2_ST_walk = "Stance time (straight), s",
    mean_stance_time_protocol2_ST_navigation = "Stance time (navigation), s",
    mean_stance_time_protocol3_ST_navigation = "Stance time (ST), s",
    mean_stance_time_protocol3_DT_navigation = "Stance time (DT), s",
